              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  <carousel class="product-thumbs-track ps-slider " :nav="false" :dots="false" >
                    <div class="pt active" @click="changeImage(thumbs[0]) == gambar_default? 'active' :'' ">
                      <img src="img/products/dark01.PNG" alt="" />
                    </div>
                    <div class="pt" @click="changeImage(thumbs[1]) == gambar_default? 'active' :''">
                      <img src="img/products/dark02.PNG" alt="" />
                    </div>
                    <div class="pt" @click="changeImage(thumbs[2]) == gambar_default? 'active' :''">
                      <img src="img/products/dark01.PNG" alt="" />
                    </div>
                    <div class="pt" @click="changeImage(thumbs[3]) == gambar_default? 'active' :''">
                      <img src="img/products/elite01.PNG" alt="" />
                    </div>
                  </carousel>
                </div>
              </div>
...
<script>
// @ is an alias to /srcs
import HeaderBrinxid from "@/components/HeaderBrinxid.vue";
import RealetedBrinxid from "@/components/RealetedBrinxid.vue";
import FooterBrinxid from "@/components/FooterBrinxid.vue";
...
export default {
  ...
  data(){
      return{
          gambar_default:"img/m_dark01.PNG",
          thumbs: [
              "img/products/dark01.PNG",
              "img/products/dark02.PNG",
              "img/products/dark01.PNG",
              "img/products/elite01.PNG"
          ]
      }
  },
  methods: {
